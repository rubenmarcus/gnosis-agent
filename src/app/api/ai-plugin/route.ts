 ...
 paths:{
      '/api/pilot/get-portfolio': {
        get: {
          ...
          description: 'Fetches the current token holdings and liquidity positions for a given address on Gnosis Chain',
          ...
          parameters: [
            {
              ...
              description: 'The EVM address to fetch portfolio data for',
            },
          ],
          responses: {
            '200': {
                    ...
                    properties: {
                      portfolio: {
                        ...
                        properties: {
                          ...
                          network: {
                            type: 'string',
                            description: 'The blockchain network (gnosis)',
                          },
                          balances: {
                            type: 'array',
                            items: {
                          ...
                          lpPositions: {
                            ...
                            items: {
                              ...
                              properties: {
                                ...
                                pair: {
                                  type: 'string',
                                  description: 'Token pair in the LP position',
                                },
                                value: {
                                  type: 'string',
                                  description: 'USD value of the LP position',
                                },
                                apr: {
                                  type: 'string',
